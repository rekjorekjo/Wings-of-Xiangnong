package com.ordering.module.store.dal.dataobject.storeshop;
 ...
 * @author project team
 */
@TableName(value = "app_store_shop",autoResultMap = true)
@KeySequence("app_store_shop_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
