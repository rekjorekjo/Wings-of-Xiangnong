...
import com.wings.module.product.controller.app.product.vo.AppReplyCountVo;
...
import com.wings.module.product.enums.ProductConstants;
import com.wings.module.product.enums.product.ScoreEnum;
...
public class AppStoreProductReplyServiceImpl extends ServiceImpl<StoreProductReplyMapper, StoreProductReplyDO> implements AppStoreProductReplyService {
    ...
    public String replyPer(long productId) {
        ...
        return ShopConstants.WINGS_ZERO;
    }
