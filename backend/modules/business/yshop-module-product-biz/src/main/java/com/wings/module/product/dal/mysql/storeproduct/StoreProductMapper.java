package com.wings.module.product.dal.mysql.storeproduct;
...
import com.wings.module.product.enums.product.DefaultEnum;
...
//        }
    ...
    @Update("update wings_store_product set is_show = #{status} where id = #{id}")
     ...
     * @return
     */
    @Update("update wings_store_product set stock=stock+#{num}, sales=sales-#{num}" +
            " where id=#{productId}")
