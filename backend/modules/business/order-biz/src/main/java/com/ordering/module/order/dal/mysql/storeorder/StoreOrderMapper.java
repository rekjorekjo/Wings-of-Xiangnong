package com.ordering.module.order.dal.mysql.storeorder;
...
import com.ordering.module.order.enums.AdminOrderStatusEnum;
import com.ordering.module.order.enums.OrderLogEnum;
import com.ordering.framework.common.enums.OrderTypeEnum;
...
public interface StoreOrderMapper extends BaseMapperX<StoreOrderDO> {
    ...
    @Select("SELECT IFNULL(sum(pay_price),0) " +
            " FROM app_store_order ${ew.customSqlSegment}")
