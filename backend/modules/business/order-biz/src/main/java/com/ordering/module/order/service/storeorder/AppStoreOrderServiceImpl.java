...
import com.ordering.framework.common.enums.OrderInfoEnum;
import com.ordering.framework.common.enums.PayIdEnum;
import com.ordering.framework.common.enums.ShopCommonEnum;
import com.ordering.framework.common.exception.ErrorCode;
import com.ordering.framework.tenant.core.aop.TenantIgnore;
...
import com.ordering.module.member.controller.app.user.vo.AppUserQueryVo;
import com.ordering.module.member.dal.dataobject.user.MemberUserDO;
import com.ordering.module.member.dal.dataobject.useraddress.UserAddressDO;
import com.ordering.module.member.dal.dataobject.userbill.UserBillDO;
import com.ordering.module.member.enums.BillDetailEnum;
import com.ordering.module.member.service.user.MemberUserService;
import com.ordering.module.member.service.useraddress.AppUserAddressService;
import com.ordering.module.member.service.userbill.UserBillService;
import com.ordering.module.message.enums.WechatTempateEnum;
import com.ordering.module.message.mq.producer.WeixinNoticeProducer;
import com.ordering.module.message.redismq.msg.OrderMsg;
import com.ordering.module.order.controller.app.order.param.AppOrderParam;
import com.ordering.module.order.controller.app.order.param.AppPayParam;
import com.ordering.module.order.controller.app.order.vo.AppStoreOrderQueryVo;
import com.ordering.module.order.convert.storeorder.StoreOrderConvert;
...
import com.ordering.module.order.dal.dataobject.storeordercartinfo.StoreOrderCartInfoDO;
import com.ordering.module.order.dal.mysql.ordernumber.OrderNumberMapper;
import com.ordering.module.order.dal.mysql.storeorder.StoreOrderMapper;
import com.ordering.module.order.enums.AppFromEnum;
import com.ordering.module.order.enums.OrderLogEnum;
import com.ordering.module.order.enums.OrderStatusEnum;
import com.ordering.module.order.enums.PayTypeEnum;
import com.ordering.module.order.service.storeorder.dto.StatusDto;
import com.ordering.module.order.service.storeordercartinfo.StoreOrderCartInfoService;
import com.ordering.module.order.service.storeorderstatus.StoreOrderStatusService;
import com.ordering.module.pay.dal.dataobject.merchantdetails.MerchantDetailsDO;
import com.ordering.module.pay.service.merchantdetails.MerchantDetailsService;
import com.ordering.module.product.dal.dataobject.storeproduct.StoreProductDO;
import com.ordering.module.product.dal.dataobject.storeproductattrvalue.StoreProductAttrValueDO;
import com.ordering.module.product.service.storeproduct.AppStoreProductService;
import com.ordering.module.product.service.storeproductattrvalue.StoreProductAttrValueService;
import com.ordering.module.store.convert.storeshop.StoreShopConvert;
import com.ordering.module.store.dal.dataobject.storeshop.StoreShopDO;
import com.ordering.module.store.service.storeshop.AppStoreShopService;
...
import static com.ordering.module.member.enums.ErrorCodeConstants.COUPON_NOT_CONDITION;
import static com.ordering.module.member.enums.ErrorCodeConstants.USER_ADDRESS_NOT_EXISTS;
import static com.ordering.module.order.enums.ErrorCodeConstants.*;
...
public class AppStoreOrderServiceImpl extends ServiceImpl<StoreOrderMapper,StoreOrderDO> implements AppStoreOrderService {
     ...
     * @param uid    用户id
     * @return LegacyStoreOrderQueryVo
     */
    @Override
...
//        }
    ...
    private void regressionIntegral(AppStoreOrderQueryVo order, Integer type) {
        ...
        MemberUserDO legacyUser = userService.getById(order.getUid());

        //增加积分
        BigDecimal newIntegral = NumberUtil.add(order.getUseIntegral(), legacyUser.getIntegral());
        legacyUser.setIntegral(newIntegral);
        userService.updateById(legacyUser);

        //增加流水
        billService.income(legacyUser.getId(), "积分回退", BillDetailEnum.CATEGORY_2.getValue(),
