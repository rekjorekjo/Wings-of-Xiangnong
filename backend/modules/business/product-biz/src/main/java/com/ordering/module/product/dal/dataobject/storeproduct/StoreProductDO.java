package com.ordering.module.product.dal.dataobject.storeproduct;
...
@KeySequence("app_store_product_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
