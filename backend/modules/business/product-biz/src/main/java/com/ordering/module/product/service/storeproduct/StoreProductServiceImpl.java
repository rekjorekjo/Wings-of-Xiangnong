package com.ordering.module.product.service.storeproduct;
...
import com.ordering.module.product.convert.storeproductrule.StoreProductRuleConvert;
import com.ordering.module.product.dal.dataobject.category.ProductCategoryDO;
...
import com.ordering.module.product.enums.product.SpecTypeEnum;
import com.ordering.module.product.service.category.ProductCategoryService;
import com.ordering.module.product.service.storeproduct.dto.*;
import com.ordering.module.product.service.storeproductattr.StoreProductAttrService;
import com.ordering.module.product.service.storeproductattrresult.StoreProductAttrResultService;
import com.ordering.module.product.service.storeproductattrvalue.StoreProductAttrValueService;
import com.ordering.module.product.service.storeproductrule.StoreProductRuleService;
...
import com.ordering.module.product.convert.storeproduct.StoreProductConvert;
import com.ordering.module.product.dal.mysql.storeproduct.StoreProductMapper;

import static com.ordering.framework.common.exception.util.ServiceExceptionUtil.exception;
import static com.ordering.module.product.enums.ErrorCodeConstants.*;
...
//            private Integer seckillStock;
    ...
    public void insertAndEditLegacyStoreProduct(StoreProductDto storeProductDto) {
        ...
        //添加商品
        StoreProductDO legacyStoreProduct = new StoreProductDO();
        BeanUtil.copyProperties(storeProductDto, legacyStoreProduct, "sliderImage");
        ...
        legacyStoreProduct.setShopName(storeShopDO.getName());
        legacyStoreProduct.setPrice(BigDecimal.valueOf(resultDTO.getMinPrice()));
        legacyStoreProduct.setOtPrice(BigDecimal.valueOf(resultDTO.getMinOtPrice()));
        legacyStoreProduct.setCost(BigDecimal.valueOf(resultDTO.getMinCost()));
        legacyStoreProduct.setIntegral(resultDTO.getMinIntegral());
        legacyStoreProduct.setStock(resultDTO.getStock());
        legacyStoreProduct.setSliderImage(String.join(",", storeProductDto.getSliderImage()));


        this.saveOrUpdate(legacyStoreProduct);
        ...
        if (SpecTypeEnum.TYPE_0.getValue().equals(storeProductDto.getSpecType())) {
            ...
            storeProductAttrService.insertLegacyStoreProductAttr(ListUtil.toList(fromatDetailDto),
                    ListUtil.toList(productFormatDto), legacyStoreProduct.getId());
        } else {
            storeProductAttrService.insertLegacyStoreProductAttr(storeProductDto.getItems(),
                    storeProductDto.getAttrs(), legacyStoreProduct.getId());
        }
