...
import com.ordering.module.product.controller.app.category.vo.AppCategoryRespVO;
import com.ordering.module.product.controller.app.product.param.AppStoreProductQueryParam;
...
import com.ordering.module.product.convert.category.ProductCategoryConvert;
...
import com.ordering.module.product.dal.mysql.storeproductattrvalue.StoreProductAttrValueMapper;
import com.ordering.module.product.enums.product.ProductEnum;
...
import com.ordering.module.product.service.storeproductattr.AppStoreProductAttrService;
import com.ordering.module.product.service.storeproductattrvalue.StoreProductAttrValueService;
import com.ordering.module.product.service.storeproductreply.AppStoreProductReplyService;
...
import static com.ordering.module.product.enums.ErrorCodeConstants.PRODUCT_STOCK_LESS;
...
public class AppStoreProductServiceImpl extends ServiceImpl<StoreProductMapper,StoreProductDO> implements AppStoreProductService {
    ...
    public List<AppStoreProductRespVo> getList(int page, int limit, int order) {
        ...
        wrapper.eq(StoreProductDO::getIsShow, ShopCommonEnum.SHOW_1.getValue())
                //.eq(LegacyStoreProduct::getIsDel,ShopCommonEnum.DELETE_0.getValue())
...
//                    .convertList03(this.baseMapper.selectList(wrapper));
     ...
     *
     * @param id 商品id
     * @return LegacyStoreProductQueryVo
     */
    @Override
