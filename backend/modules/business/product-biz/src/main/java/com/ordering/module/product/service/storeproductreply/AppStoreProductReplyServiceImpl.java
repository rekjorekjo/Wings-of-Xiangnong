...
import com.ordering.module.product.controller.app.cart.vo.AppStoreCartQueryVo;
import com.ordering.module.product.controller.app.product.vo.AppReplyCountVo;
...
import com.ordering.module.product.dal.mysql.storeproductreply.StoreProductReplyMapper;
import com.ordering.module.product.enums.ProductConstants;
import com.ordering.module.product.enums.product.ScoreEnum;
...
public class AppStoreProductReplyServiceImpl extends ServiceImpl<StoreProductReplyMapper, StoreProductReplyDO> implements AppStoreProductReplyService {
     ...
     * @return LegacyStoreProductReplyQueryVo
     */
    @Override
