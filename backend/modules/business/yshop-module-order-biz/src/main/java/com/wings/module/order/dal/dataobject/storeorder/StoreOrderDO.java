package com.wings.module.order.dal.dataobject.storeorder;
 ...
 * @author wings
 */
@TableName("wings_store_order")
@KeySequence("wings_store_order_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
