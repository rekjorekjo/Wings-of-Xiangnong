...
import com.wings.framework.tenant.core.aop.TenantIgnore;
...
import com.wings.module.coupon.service.couponuser.AppCouponUserService;
...
import com.wings.module.member.service.useraddress.AppUserAddressService;
import com.wings.module.member.service.userbill.UserBillService;
import com.wings.module.message.enums.WechatTempateEnum;
import com.wings.module.message.mq.producer.WeixinNoticeProducer;
import com.wings.module.message.redismq.msg.OrderMsg;
import com.wings.module.order.controller.app.order.param.AppOrderParam;
import com.wings.module.order.controller.app.order.param.AppPayParam;
...
import com.wings.module.order.dal.mysql.ordernumber.OrderNumberMapper;
import com.wings.module.order.dal.mysql.storeorder.StoreOrderMapper;
import com.wings.module.order.enums.AppFromEnum;
import com.wings.module.order.enums.OrderLogEnum;
import com.wings.module.order.enums.OrderStatusEnum;
import com.wings.module.order.enums.PayTypeEnum;
import com.wings.module.order.service.storeorder.dto.StatusDto;
import com.wings.module.order.service.storeordercartinfo.StoreOrderCartInfoService;
...
import com.wings.module.pay.service.merchantdetails.MerchantDetailsService;
...
import com.wings.module.store.convert.storeshop.StoreShopConvert;
import com.wings.module.store.dal.dataobject.storeshop.StoreShopDO;
import com.wings.module.store.service.storeshop.AppStoreShopService;
...
import static com.wings.module.member.enums.ErrorCodeConstants.COUPON_NOT_CONDITION;
import static com.wings.module.member.enums.ErrorCodeConstants.USER_ADDRESS_NOT_EXISTS;
...
public class AppStoreOrderServiceImpl extends ServiceImpl<StoreOrderMapper,StoreOrderDO> implements AppStoreOrderService {
    ...
    public Map<String, Object> createOrder(Long uid,  AppOrderParam param) {
        ...
        String orderSn = "";
        //todo 桌面点餐功能 商业版本才有 官网地址：https://www.wings.co
        if(OrderLogEnum.ORDER_TAKE_DESK.getValue().equals(param.getOrderType())
        ...
        ////todo 桌面点餐功能 商业版本才有 官网地址：https://www.wings.co异步更新桌面信息
    ...
    public Map<String, Object> pay(Long uid, AppPayParam param) {
        ...
        if(orderInfo != null) {
            ...
            //todo 充值商业版本才有 官网购买：https://www.wings.co
        }
