...
import com.ordering.order.dal.redis.order.AsyncCountRedisDAO;
import com.ordering.order.dal.redis.order.AsyncOrderRedisDAO;
import com.ordering.order.dal.redis.order.PrintMachineRedisDAO;
import com.ordering.order.enums.OrderLogEnum;
import com.ordering.order.service.storeorder.dto.OrderTimeDataDto;
import com.ordering.product.service.storeproduct.StoreProductService;
...
public class AsyncStoreOrderServiceImpl implements AsyncStoreOrderService {
    ...
    @Resource
    private PrintMachineRedisDAO printMachineRedisDAO;
    @Resource
    ...
    public void getOrderTimeData() {
        ...
        ShopOrderTimeDataVO shopOrderTimeData = this.getShopOrderTimeData();

        BeanUtil.copyProperties(shopOrderTimeData, orderTimeDataDto);
     ...
     * 异步后台统计
     */
    public ShopOrderTimeDataVO getShopOrderTimeData() {
        ...
        ShopOrderTimeDataVO orderTimeDataVo = new ShopOrderTimeDataVO();
