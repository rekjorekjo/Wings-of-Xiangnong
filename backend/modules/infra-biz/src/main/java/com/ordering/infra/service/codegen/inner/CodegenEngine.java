package com.ordering.infra.service.codegen.inner;
...
import com.ordering.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "${table.moduleName}-" + module + "/" + // 模块
                "src/" + src + "/java/${basePackage}/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "${table.moduleName}-biz/" + // 模块
