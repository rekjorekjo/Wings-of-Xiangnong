package com.ordering.module.member.controller.app.user.vo;
...
public class AppUserInfoRespVO {
    ...
    @Schema(description = "用户id", required = true, example = "app")
    private Long id;

    @Schema(description = "用户昵称", required = true, example = "app")
