 ...
 */
package com.ordering.module.member.controller.app.address;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.NumberUtil;
import cn.hutool.core.util.StrUtil;
import com.ordering.framework.common.pojo.CommonResult;
import com.ordering.framework.common.util.geo.LocationUtils;
import com.ordering.framework.ip.core.Area;
import com.ordering.framework.ip.core.utils.AreaUtils;
import com.ordering.framework.security.core.annotations.PreAuthenticated;
import com.ordering.module.member.controller.app.address.param.AppAddressParam;
import com.ordering.module.member.controller.app.address.vo.AppUserAddressLocationVo;
import com.ordering.module.member.controller.app.address.vo.AppUserAddressQueryVo;
import com.ordering.module.member.controller.app.address.vo.AreaNodeRespVO;
import com.ordering.module.member.convert.useraddress.AreaConvert;
...
import static com.ordering.module.member.enums.ErrorCodeConstants.USER_ADDRESS_PARAM_NOT_EXISTS;
...
public class AppUserAddressController {
    ...
    */
    ...
    public CommonResult<Long> addLegacyUserAddress(@RequestBody @Valid AppAddressParam param){
    ...
    */
    ...
    public CommonResult<Boolean> deleteLegacyUserAddress(@PathVariable String id){
    ...
    public CommonResult<List<AppUserAddressQueryVo>> getLegacyUserAddressPageList(@RequestParam(value = "page",defaultValue = "1") int page,
