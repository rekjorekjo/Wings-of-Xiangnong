package com.wings.module.member.service.auth;
...
import com.wings.module.member.controller.app.auth.vo.*;
import com.wings.module.member.convert.auth.AuthConvert;
...
import com.wings.module.member.dal.redis.order.MiniRedisDAO;
import com.wings.module.member.enums.LoginTypeEnum;
import com.wings.module.member.service.user.MemberUserService;
import com.wings.module.system.api.logger.LoginLogApi;
import com.wings.module.system.api.logger.dto.LoginLogCreateReqDTO;
import com.wings.module.system.api.oauth2.OAuth2TokenApi;
import com.wings.module.system.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import com.wings.module.system.api.oauth2.dto.OAuth2AccessTokenRespDTO;
import com.wings.module.system.api.sms.SmsCodeApi;
import com.wings.module.system.api.social.SocialUserApi;
...
//    }
    ...
    public AppAuthLoginRespVO weixinMiniAppLogin3(String encryptedData, String iv, String openid){
        ...
        if (memberUserDO == null) {
            ...
            memberUserDO.setNickname("wings用户_" + memberUserDO.getId());
