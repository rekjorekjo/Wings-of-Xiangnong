package com.wings.module.member.controller.app.user.vo;
...
public class AppUserInfoRespVO {
    ...
    @Schema(description = "用户id", required = true, example = "wings")
    private Long id;

    @Schema(description = "用户昵称", required = true, example = "wings")
