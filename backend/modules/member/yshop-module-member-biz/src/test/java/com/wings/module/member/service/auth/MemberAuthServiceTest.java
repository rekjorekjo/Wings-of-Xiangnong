...
import com.wings.framework.redis.config.WingsRedisAutoConfiguration;
import com.wings.framework.test.core.ut.BaseDbAndRedisUnitTest;
import com.wings.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import com.wings.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
...
// TODO @wings：单测的 review，等逻辑都达成一致后
/**
 * {@link MemberAuthService} 的单元测试类
 *
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, WingsRedisAutoConfiguration.class})
public class MemberAuthServiceTest extends BaseDbAndRedisUnitTest {

    // TODO @wings：登录相关的单测，待补全
