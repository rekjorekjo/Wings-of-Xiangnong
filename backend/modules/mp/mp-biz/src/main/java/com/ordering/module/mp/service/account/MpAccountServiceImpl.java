package com.ordering.module.mp.service.account;
...
import com.ordering.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.ordering.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.ordering.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.ordering.module.mp.convert.account.MpAccountConvert;
import com.ordering.module.mp.dal.dataobject.account.MpAccountDO;
import com.ordering.module.mp.dal.mysql.account.MpAccountMapper;
import com.ordering.module.mp.enums.ErrorCodeConstants;
import com.ordering.module.mp.framework.mp.core.MpServiceFactory;
...
import static com.ordering.framework.common.util.collection.CollectionUtils.getMaxValue;
import static com.ordering.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 mp - 表结构未导入][参考 http://localhost:80/mp/build/ 开启]");
            }
