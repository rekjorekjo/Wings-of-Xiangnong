package com.ordering.module.mp.controller.admin.material.vo;
...
public class MpMaterialRespVO {
    ...
    @Schema(description = "素材的 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "http://localhost:80/1.png")
    private String url;


    @Schema(description = "名字", example = "app.png")
    private String name;
