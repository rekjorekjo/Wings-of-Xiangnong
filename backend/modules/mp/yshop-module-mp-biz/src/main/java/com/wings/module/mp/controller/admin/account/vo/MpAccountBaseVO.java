package com.wings.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "wings")
    @NotEmpty(message = "名称不能为空")
    private String name;

    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "wingsyuanma")
    ...
    @Schema(description = "备注", example = "请关注wings，学习技术")
