package com.wings.module.mp.controller.admin.material.vo;
...
public class MpMaterialRespVO {
    ...
    @Schema(description = "素材的 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.wings.co/1.png")
    private String url;


    @Schema(description = "名字", example = "wings.png")
    private String name;
