...
import com.ordering.framework.test.core.util.RandomUtils;
import com.ordering.system.dal.dataobject.mail.MailAccountDO;
import com.ordering.system.dal.dataobject.mail.MailTemplateDO;
import com.ordering.system.dal.dataobject.user.AdminUserDO;
import com.ordering.system.mq.message.mail.MailSendMessage;
import com.ordering.system.mq.producer.mail.MailProducer;
...
//                .setFrom("奥特曼 <ydym_test@163.com>")
    ...
    public void testDoSendMail_success() {
        try (final MockedStatic<MailUtil> mailUtilMock = mockStatic(MailUtil.class)) {
            // 准备参数
            MailSendMessage message = randomPojo(MailSendMessage.class, o -> o.setNickname("app"));
            // mock 方法（获得邮箱账号）
            ...
            mailUtilMock.when(() -> MailUtil.send(
                    argThat(mailAccount -> {
                        assertEquals("app <7685@qq.com>", mailAccount.getFrom());
