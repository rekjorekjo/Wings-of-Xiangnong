package com.wings.module.system.service.permission;

import com.wings.framework.common.enums.CommonStatusEnum;
import com.wings.framework.test.core.ut.BaseDbUnitTest;
import com.wings.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.wings.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.wings.module.system.dal.dataobject.permission.MenuDO;
import com.wings.module.system.dal.mysql.permission.MenuMapper;
import com.wings.module.system.enums.permission.MenuTypeEnum;
...
import static com.wings.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("wings").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
