...
import com.wings.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.wings.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.wings.module.system.dal.dataobject.social.SocialClientDO;
import com.wings.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("https://www.wings.co?redirect_uri=yyy");

            // 调用
            String url = socialClientService.getAuthorizeUrl(socialType, userType, redirectUri);
            // 断言
            assertEquals("https://www.wings.co?redirect_uri=sss", url);
        }
    }
