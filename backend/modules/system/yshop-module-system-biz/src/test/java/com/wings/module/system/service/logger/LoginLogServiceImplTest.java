...
import static com.wings.module.system.enums.logger.LoginResultEnum.CAPTCHA_CODE_ERROR;
import static com.wings.module.system.enums.logger.LoginResultEnum.SUCCESS;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        // 测试 username 不匹配
        loginLogMapper.insert(cloneIgnoreId(loginLogDO, o -> o.setUsername("wings")));
        // 测试 createTime 不匹配
