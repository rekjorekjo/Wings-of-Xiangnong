package com.wings.module.system.service.mail;
...
import com.wings.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.wings.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.wings.module.system.dal.dataobject.mail.MailTemplateDO;
import com.wings.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.wings.framework.test.core.util.RandomUtils.randomLongId;
import static com.wings.framework.test.core.util.RandomUtils.randomPojo;
import static com.wings.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("wings")));
        // 测试 code 不匹配
