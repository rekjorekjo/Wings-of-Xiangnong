package com.wings.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.wings.framework.common.enums.CommonStatusEnum;
import com.wings.framework.common.exception.ServiceException;
import com.wings.framework.common.pojo.PageResult;
import com.wings.framework.common.util.collection.ArrayUtils;
import com.wings.framework.common.util.collection.CollectionUtils;
import com.wings.framework.test.core.ut.BaseDbUnitTest;
import com.wings.module.infra.api.file.FileApi;
import com.wings.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.wings.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.wings.module.system.controller.admin.user.vo.user.*;
import com.wings.module.system.dal.dataobject.dept.DeptDO;
import com.wings.module.system.dal.dataobject.dept.PostDO;
import com.wings.module.system.dal.dataobject.dept.UserPostDO;
import com.wings.module.system.dal.dataobject.tenant.TenantDO;
import com.wings.module.system.dal.dataobject.user.AdminUserDO;
import com.wings.module.system.dal.mysql.dept.UserPostMapper;
import com.wings.module.system.dal.mysql.user.AdminUserMapper;
import com.wings.module.system.enums.common.SexEnum;
import com.wings.module.system.service.dept.DeptService;
import com.wings.module.system.service.dept.PostService;
import com.wings.module.system.service.permission.PermissionService;
import com.wings.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("wingsyuanma");
        ...
        assertEquals("wingsyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("wingsyuanma"))).thenReturn("java");
