package com.wings.module.system.controller.admin.socail.vo.client;

import cn.hutool.core.util.StrUtil;
import com.wings.framework.common.enums.CommonStatusEnum;
import com.wings.framework.common.enums.UserTypeEnum;
import com.wings.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "wings商城")
