...
import com.wings.framework.common.util.http.HttpUtils;
...
import com.wings.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.wings.module.system.util.oauth2.OAuth2Utils;
...
import static com.wings.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.wings.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.wings.framework.common.pojo.CommonResult.success;
import static com.wings.framework.common.util.collection.CollectionUtils.convertList;
import static com.wings.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.wings.co"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.wings.co"),
