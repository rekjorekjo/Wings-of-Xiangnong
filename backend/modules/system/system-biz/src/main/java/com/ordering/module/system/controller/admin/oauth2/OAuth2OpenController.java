...
import com.ordering.framework.common.util.http.HttpUtils;
...
import com.ordering.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.ordering.module.system.util.oauth2.OAuth2Utils;
...
import static com.ordering.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.ordering.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "http://localhost:80"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "http://localhost:80"),
