package com.ordering.module.system.service.user;
...
import com.ordering.framework.common.util.collection.ArrayUtils;
import com.ordering.framework.common.util.collection.CollectionUtils;
import com.ordering.framework.test.core.ut.BaseDbUnitTest;
import com.ordering.module.infra.api.file.FileApi;
import com.ordering.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.ordering.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.ordering.module.system.controller.admin.user.vo.user.*;
import com.ordering.module.system.dal.dataobject.dept.DeptDO;
import com.ordering.module.system.dal.dataobject.dept.PostDO;
import com.ordering.module.system.dal.dataobject.dept.UserPostDO;
import com.ordering.module.system.dal.dataobject.tenant.TenantDO;
import com.ordering.module.system.dal.dataobject.user.AdminUserDO;
import com.ordering.module.system.dal.mysql.dept.UserPostMapper;
import com.ordering.module.system.dal.mysql.user.AdminUserMapper;
import com.ordering.module.system.enums.common.SexEnum;
import com.ordering.module.system.service.dept.DeptService;
import com.ordering.module.system.service.dept.PostService;
import com.ordering.module.system.service.permission.PermissionService;
import com.ordering.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("demo");
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("demo"))).thenReturn("java");
