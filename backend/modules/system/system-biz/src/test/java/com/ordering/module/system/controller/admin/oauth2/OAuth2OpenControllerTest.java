package com.ordering.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.ordering.framework.common.core.KeyValue;
...
import com.ordering.framework.common.util.collection.SetUtils;
import com.ordering.framework.common.util.object.ObjectUtils;
import com.ordering.framework.test.core.ut.BaseMockitoUnitTest;
import com.ordering.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.ordering.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.ordering.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.ordering.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.ordering.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.ordering.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.ordering.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.ordering.module.system.service.oauth2.OAuth2ApproveService;
import com.ordering.module.system.service.oauth2.OAuth2ClientService;
import com.ordering.module.system.service.oauth2.OAuth2GrantService;
import com.ordering.module.system.service.oauth2.OAuth2TokenService;
...
import static com.ordering.framework.test.core.util.RandomUtils.randomPojo;
import static com.ordering.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("http://localhost:80#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("http://localhost:80#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("http://localhost:80#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("http://localhost:80?code=test_code&state=test", result.getData());
    }
