package com.ordering.module.system.service.permission;
...
import com.ordering.module.system.api.permission.dto.DeptDataPermissionRespDTO;
...
import com.ordering.module.system.dal.dataobject.permission.RoleMenuDO;
import com.ordering.module.system.dal.dataobject.permission.UserRoleDO;
import com.ordering.module.system.dal.dataobject.user.AdminUserDO;
import com.ordering.module.system.dal.mysql.permission.RoleMenuMapper;
import com.ordering.module.system.dal.mysql.permission.UserRoleMapper;
import com.ordering.module.system.enums.permission.DataScopeEnum;
...
import static com.ordering.framework.test.core.util.RandomUtils.randomLongId;
...
public class PermissionServiceTest extends BaseDbUnitTest {
    ...
    public void testHasAnyRoles() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            // 准备参数
            Long userId = 1L;
            String[] roles = new String[]{"app", "tudou"};
            // mock 用户与角色的缓存
            userRoleMapper.insert(randomPojo(UserRoleDO.class).setUserId(userId).setRoleId(100L));
