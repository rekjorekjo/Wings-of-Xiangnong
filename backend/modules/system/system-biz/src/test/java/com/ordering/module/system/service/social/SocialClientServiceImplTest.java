...
import com.ordering.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.ordering.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.ordering.module.system.dal.dataobject.social.SocialClientDO;
import com.ordering.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("http://localhost:80?redirect_uri=yyy");

            // 调用
            String url = socialClientService.getAuthorizeUrl(socialType, userType, redirectUri);
            // 断言
            assertEquals("http://localhost:80?redirect_uri=sss", url);
        }
    }
