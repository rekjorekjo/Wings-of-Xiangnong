...
import com.ordering.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.ordering.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.ordering.module.system.dal.dataobject.permission.MenuDO;
import com.ordering.module.system.dal.mysql.permission.MenuMapper;
import com.ordering.module.system.enums.permission.MenuTypeEnum;
...
import static com.ordering.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("app").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
