package com.ordering.module.pay.controller.admin.merchantdetails.vo;

import com.ordering.framework.desensitize.core.slider.annotation.SliderDesensitize;
...
public class MerchantDetailsBaseVO {
    ...
    @Schema(description = "异步回调", example = "http://localhost:80")
    private String notifyUrl;

    @Schema(description = "同步回调地址，大部分用于付款成功后页面转跳", example = "http://localhost:80")
