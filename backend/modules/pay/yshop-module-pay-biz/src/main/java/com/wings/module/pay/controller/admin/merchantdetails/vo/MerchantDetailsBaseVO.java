package com.wings.module.pay.controller.admin.merchantdetails.vo;

import com.wings.framework.desensitize.core.slider.annotation.SliderDesensitize;
...
public class MerchantDetailsBaseVO {
    ...
    @Schema(description = "异步回调", example = "https://www.wings.co")
    private String notifyUrl;

    @Schema(description = "同步回调地址，大部分用于付款成功后页面转跳", example = "https://www.wings.co")
