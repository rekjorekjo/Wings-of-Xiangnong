package com.ordering.product.dal.mysql.storeproduct;
...
import com.ordering.product.enums.product.DefaultEnum;
...
//        }
    ...
    @Update("update app_store_product set is_show = #{status} where id = #{id}")
     ...
     * @return
     */
    @Update("update app_store_product set stock=stock+#{num}, sales=sales-#{num}" +
            " where id=#{productId}")
