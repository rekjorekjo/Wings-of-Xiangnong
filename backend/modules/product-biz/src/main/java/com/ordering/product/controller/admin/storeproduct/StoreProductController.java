package com.ordering.product.controller.admin.storeproduct;
...
import com.ordering.product.service.storeproduct.dto.StoreProductDto;
...
public class StoreProductController {
    ...
    public CommonResult<Boolean> createStoreProduct(@Validated @RequestBody StoreProductDto storeProductDto) {
        storeProductService.insertAndEditLegacyStoreProduct(storeProductDto);
        return success(true);
    }
