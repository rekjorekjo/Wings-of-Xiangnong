package com.ordering.module.infra.service.codegen.inner;
...
import com.ordering.framework.apilog.core.enums.OperateTypeEnum;
import com.ordering.framework.common.exception.util.ServiceExceptionUtil;
...
import com.ordering.framework.common.util.date.LocalDateTimeUtils;
...
import com.ordering.framework.excel.core.annotations.DictFormat;
import com.ordering.framework.excel.core.convert.DictConvert;
...
import com.ordering.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String vueFilePath(String path) {
        return "app-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "app-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
