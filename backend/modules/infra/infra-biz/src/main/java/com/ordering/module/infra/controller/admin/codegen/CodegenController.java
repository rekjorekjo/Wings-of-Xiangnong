package com.ordering.module.infra.controller.admin.codegen;
...
import com.ordering.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.ordering.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.ordering.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.ordering.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.ordering.module.infra.convert.codegen.CodegenConvert;
...
import com.ordering.module.infra.service.codegen.CodegenService;
...
import static com.ordering.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "app"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "app")
    })
