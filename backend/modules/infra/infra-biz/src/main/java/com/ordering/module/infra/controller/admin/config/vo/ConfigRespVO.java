package com.ordering.module.infra.controller.admin.config.vo;
...
import com.ordering.module.infra.enums.DictTypeConstants;
...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "app.db.username")
    @ExcelProperty("参数键名")
    private String key;
