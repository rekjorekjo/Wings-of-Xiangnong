package com.ordering.module.infra.framework.file.core.client.s3;
...
public class S3FileClientConfig implements FileClientConfig {
    ...
    /**
     * 节点地址
     * 1. MinIO：http://localhost:80/Spring-Boot/MinIO 。例如说，http://127.0.0.1:9000
    ...
    /**
     * 访问 Key
     * 1. MinIO：http://localhost:80/Spring-Boot/MinIO
