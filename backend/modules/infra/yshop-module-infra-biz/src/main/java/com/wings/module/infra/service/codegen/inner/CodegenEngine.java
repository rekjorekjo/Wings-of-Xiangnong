package com.wings.module.infra.service.codegen.inner;
...
import com.wings.framework.apilog.core.annotation.ApiAccessLog;
import com.wings.framework.apilog.core.enums.OperateTypeEnum;
import com.wings.framework.common.exception.util.ServiceExceptionUtil;
...
import com.wings.framework.common.util.date.LocalDateTimeUtils;
import com.wings.framework.common.util.object.BeanUtils;
import com.wings.framework.common.util.object.ObjectUtils;
import com.wings.framework.common.util.string.StrUtils;
import com.wings.framework.excel.core.annotations.DictFormat;
import com.wings.framework.excel.core.convert.DictConvert;
import com.wings.framework.excel.core.util.ExcelUtils;
...
import com.wings.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.wings.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.wings.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.wings.module.infra.enums.codegen.CodegenSceneEnum;
import com.wings.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.wings.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "wings-module-${table.moduleName}/" + // 顶级模块
                "wings-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "wings-module-${table.moduleName}/" + // 顶级模块
                "wings-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "wings-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "wings-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
