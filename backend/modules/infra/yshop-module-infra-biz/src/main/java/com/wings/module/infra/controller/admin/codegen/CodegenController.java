package com.wings.module.infra.controller.admin.codegen;
...
import com.wings.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.wings.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.wings.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.wings.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.wings.module.infra.convert.codegen.CodegenConvert;
...
import com.wings.module.infra.service.codegen.CodegenService;
...
import static com.wings.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "wings"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "wings")
    })
