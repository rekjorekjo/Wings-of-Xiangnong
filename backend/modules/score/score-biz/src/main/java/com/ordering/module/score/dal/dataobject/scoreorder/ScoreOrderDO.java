package com.ordering.module.score.dal.dataobject.scoreorder;
 ...
 * @author project team
 */
@TableName("app_score_order")
@KeySequence("app_score_order_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
