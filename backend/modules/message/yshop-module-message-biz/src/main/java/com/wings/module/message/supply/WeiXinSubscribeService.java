package com.wings.module.message.supply;
...
import com.wings.module.member.api.user.dto.WechatUserDto;
...
import com.wings.module.message.service.wechattemplate.WechatTemplateService;
...
public class WeiXinSubscribeService {
    ...
    public void rechargeSuccessNotice(String time,String price,Long uid){
        ...
        map.put("remark", ShopConstants.WINGS_WECHAT_PUSH_REMARK);
