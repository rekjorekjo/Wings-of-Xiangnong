package com.ordering.mp.controller.admin.message.vo.autoreply;
...
public class MpAutoReplyBaseVO {
    ...
    @Schema(description = "回复的媒体 URL", example = "http://localhost:80/xxx.jpg")
    @NotEmpty(message = "回复的消息 mediaId 不能为空",
            groups = {ImageMessageGroup.class, VoiceMessageGroup.class, VideoMessageGroup.class})
    ...
    @Schema(description = "缩略图的媒体 URL",example = "http://localhost:80/xxx.jpg")
    ...
    @Schema(description = "回复的音乐链接", example = "http://localhost:80/xxx.mp3")
    ...
    @Schema(description = "高质量音乐链接", example = "http://localhost:80/xxx.mp3")
