package com.ordering.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.ordering.framework.common.pojo.PageResult;
import com.ordering.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.ordering.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.ordering.mp.convert.message.MpMessageConvert;
import com.ordering.mp.dal.dataobject.account.MpAccountDO;
import com.ordering.mp.dal.dataobject.message.MpMessageDO;
import com.ordering.mp.dal.dataobject.user.MpUserDO;
import com.ordering.mp.dal.mysql.message.MpMessageMapper;
import com.ordering.mp.enums.message.MpMessageSendFromEnum;
import com.ordering.mp.framework.mp.core.MpServiceFactory;
import com.ordering.mp.framework.mp.core.util.MpUtils;
import com.ordering.mp.service.account.MpAccountService;
import com.ordering.mp.service.material.MpMaterialService;
import com.ordering.mp.service.message.bo.MpMessageSendOutReqBO;
import com.ordering.mp.service.user.MpUserService;
...
import static com.ordering.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
