package com.ordering.mp.controller.admin.menu.vo;
...
import static com.ordering.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "http://localhost:80/")
