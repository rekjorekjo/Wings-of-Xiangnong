package com.ordering.framework.tracer.config;

import com.ordering.framework.common.enums.WebFilterOrderEnum;
import com.ordering.framework.tracer.core.aop.BizTraceAspect;
import com.ordering.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "app.tracer", value = "enable", matchIfMissing = true)
