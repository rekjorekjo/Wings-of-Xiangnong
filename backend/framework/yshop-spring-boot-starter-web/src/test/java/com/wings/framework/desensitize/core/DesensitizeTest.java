package com.wings.framework.desensitize.core;

import com.wings.framework.common.util.json.JsonUtils;
import com.wings.framework.desensitize.core.annotation.Address;
import com.wings.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.wings.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.wings.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("wings");
        ...
        desensitizeDemo.setRegex("你好，我是wings");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("wings");
        ...
        assertEquals("wings", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "wings", replacer = "*")
