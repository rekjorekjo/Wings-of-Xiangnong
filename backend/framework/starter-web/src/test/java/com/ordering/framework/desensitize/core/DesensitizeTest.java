package com.ordering.framework.desensitize.core;

import com.ordering.framework.common.util.json.JsonUtils;
import com.ordering.framework.desensitize.core.annotation.Address;
import com.ordering.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.ordering.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.ordering.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("app");
        ...
        desensitizeDemo.setRegex("你好，我是app");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("app");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "app", replacer = "*")
