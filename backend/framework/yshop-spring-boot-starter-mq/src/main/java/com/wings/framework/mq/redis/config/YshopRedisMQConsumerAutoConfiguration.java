package com.wings.framework.mq.redis.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.wings.framework.common.enums.DocumentEnum;
import com.wings.framework.mq.redis.core.RedisMQTemplate;
import com.wings.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.wings.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
...
@ConditionalOnProperty(prefix = "wings.redis-mq", name = "enabled", havingValue = "true", matchIfMissing = true)
public class WingsRedisMQConsumerAutoConfiguration {
