package com.ordering.framework.mq.redis.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.ordering.framework.common.enums.DocumentEnum;
import com.ordering.framework.mq.redis.core.RedisMQTemplate;
import com.ordering.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.ordering.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
...
@ConditionalOnProperty(prefix = "app.redis-mq", name = "enabled", havingValue = "true", matchIfMissing = true)
