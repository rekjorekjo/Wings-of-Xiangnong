...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ordering";
    private static final String ARTIFACT_ID = "app";
    private static final String PACKAGE_NAME = "com.ordering";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ordering";
        String artifactIdNew = "app";
        String packageNameNew = "com.ordering";
