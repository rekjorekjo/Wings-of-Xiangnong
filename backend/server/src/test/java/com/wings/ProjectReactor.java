...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.wings";
    private static final String ARTIFACT_ID = "wings";
    private static final String PACKAGE_NAME = "com.wings";
    private static final String TITLE = "香农之翼管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.wings";
        String artifactIdNew = "wings";
        String packageNameNew = "com.wings";
        String titleNew = "香农之翼管理系统";
