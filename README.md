...
**项目定位**：这是一个面向校园/园区点餐与智能配送管理的二次开发项目，基于 yshop-drink 开源项目进行改造。当前无人机接入尚未启用，delivery 模块处于 mock-backed MVP 阶段。
...
**无人机部分**：当前主要是配送任务与状态展示，真实无人机调度尚未完全接入。delivery 管理端页面请求后端 delivery mock API，数据由后端 DeliveryMockDataProvider 提供。
